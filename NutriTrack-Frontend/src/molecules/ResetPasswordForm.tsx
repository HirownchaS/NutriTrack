    ...
    return (
        <Card className="w-full max-w-md p-8 bg-white/80 backdrop-blur-lg shadow-xl rounded-2xl">
            <div className="text-center mb-8">
                ...
                {email && <p className="text-slate-500 mt-2">Resetting password for <span className="font-semibold text-emerald-600">{email}</span></p>}
            </div>
            ...
            {success ? (
                <div className="text-center py-4">
                    ...
                    <p className="text-slate-600 mb-6">Password reset successful. Redirecting to login...</p>
                    <Link to="/login">
                        <Button variant="primary" className="w-full">Go to Login Now</Button>
                    </Link>
                </div>
            ) : (
