      ...
      <Card className="overflow-hidden">
        ...
        <div className="px-6 py-4 grid grid-cols-2 sm:grid-cols-5 gap-3 border-b border-slate-100">
          {[
            {
              label: "Calories",
              value: `${Math.round(totals.totalCalories)}`,
              unit: "kcal",
              icon: "🔥",
            },
            {
              label: "Protein",
              value: `${totals.totalProtein.toFixed(1)}`,
              unit: "g",
              icon: "🥩",
            },
            {
              label: "Carbs",
              value: `${totals.totalCarbs.toFixed(1)}`,
              unit: "g",
              icon: "🍞",
            },
            {
            ...
            {
              label: "Fiber",
              value: `${(totals.totalFiber ?? 0).toFixed(1)}`,
              unit: "g",
              icon: "🌿",
            },
          ].map((item) => (
            <div
              key={item.label}
              className="flex flex-col items-center py-2 px-3 bg-slate-50 rounded-xl"
            >
