    ...
    return (
        <Card className="flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-5 flex-grow flex flex-col">
                <h3 className="text-xl font-bold text-slate-800 mb-1">{nutritionist.name}</h3>
                ...
                <div className="space-y-2 mt-3 text-slate-600">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">{nutritionist.experience} Experience</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="mt-auto pt-6">
                    {isAccepted ? (
                        <Button
                            ...
                            onClick={() => navigate('/dashboard/chat', { state: { recipientId: nutritionist.id, recipientName: nutritionist.name } })}
                        >
                            Open Chat
                        </Button>
                    ) : isRejected ? (
