        ...
        <Card className="hover:-translate-y-1 transition-transform duration-300">
            <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                    <h3 className="text-lg font-bold text-slate-800 truncate pr-2" title={food.name}>
                        {food.name}
                    </h3>
                    {food.confidence && (
                ...
                <div className="mt-2 space-y-2">
                    <div className="flex justify-between items-center text-sm bg-slate-50 p-2 rounded-lg mb-2">
                        ...
                        <span className="font-bold text-emerald-600 text-base">{food.calories} kcal</span>
                    </div>
