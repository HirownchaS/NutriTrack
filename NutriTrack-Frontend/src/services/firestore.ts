...
// save detection
export const saveDetectionToFirestore = async (
  userId: string,
  detections: Detection[],
  nutrition: NutritionSummaryData,
) => {
  ...
  return (
    await addDoc(collection(db, "food_detections"), {
      userId,
      foods,
      nutrition,
      meal: getMealType(),
...
export const deleteDetection = (id: string) =>
  deleteDoc(doc(db, "food_detections", id));

// save food log
export const saveFoodLogToFirestore = async (
  userId: string,
  foodName: string,
  nutrition: NutritionSummaryData,
  mealType?: string,
...
// manual log
export const addManualFoodLogToFirestore = async (
  userId: string,
  data: any,
) => {
  return (
...
export const trackMealToFirestore = async (
  userId: string,
  mealType: string,
  food: {
    name: string;
