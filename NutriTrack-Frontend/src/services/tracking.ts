...
import { collection, query, where, getDocs, addDoc, doc, updateDoc, serverTimestamp, getDoc, orderBy, Timestamp, limit, writeBatch, startAfter } from 'firebase/firestore';
import { trackMealToFirestore, getDailyTrackingFromFirestore } from './firestore';
