    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1 font-medium">
          Manage your personal details and nutritional preferences.
        </p>
      </div>

      {error && (
        <div
          className="p-4 bg-red-50 text-red-700 rounded-2xl text-sm font-bold border border-red-200 shadow-sm"
          role="alert"
        >
          ❌ {error}
        </div>
      ...
      {saved && (
        <div
          className="p-4 bg-emerald-50 text-emerald-700 rounded-2xl text-sm font-bold border border-emerald-200 shadow-sm animate-fade-in"
          role="status"
        >
        ...
        <Card className="p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <fieldset className="space-y-5">
              <legend className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2 px-1">
                Basic Information
              </legend>
