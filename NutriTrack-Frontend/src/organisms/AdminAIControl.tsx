      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium mt-1">
            Monitor YOLOv8 performance and trigger model updates.
          </p>
        </div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                ...
                {
                  label: "Precision",
                  value: `${((modelInfo?.precision || 0) * 100).toFixed(1)}%`,
                  color: "text-blue-600",
                },
                {
                  label: "Recall",
                  value: `${((modelInfo?.recall || 0) * 100).toFixed(1)}%`,
            ...
            <div className="flex gap-4">
              ...
              <Button
                variant="secondary"
                className="flex-1 border-slate-200 py-4"
              >
          ...
          <Card className="p-6 border-slate-200">
            ...
            <div className="p-8 text-center bg-slate-50 rounded-xl border border-dashed border-slate-200">
              <p className="text-slate-400 text-xs italic">
                Detailed training metrics are currently unavailable.
              </p>
            </div>
          </Card>

          <Card className="p-6 bg-gradient-to-br from-indigo-600 to-purple-700 text-white border-0">
            <h4 className="font-black mb-2 uppercase text-[10px] tracking-widest opacity-80">
              Dataset Health
            </h4>
            <p className="text-xs text-white/70 leading-relaxed italic">
              System is monitoring dataset distribution. Health report will
              appear here.
            </p>
          </Card>
        </div>
