...
const NotificationItem: React.FC<{ notification: Notification; onRemove: () => void }> = ({ notification, onRemove }) => {
    ...
    return (
        <div className={`pointer-events-auto flex items-start gap-3 p-4 border rounded-xl shadow-lg max-w-sm w-full animate-fade-in transition-all ${styles[notification.type]}`}>
